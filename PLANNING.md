...
- [x] Interactive design sessions (same branch, operator feedback 2026-08-22): `c` cuts a worktree, mints a session id (`--session-id`) and hands the terminal to a real `claude`; one conversation, entered or typed into (protocol 10)
